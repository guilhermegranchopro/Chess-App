...
begin
  ...
  begin
    ...
    begin
      //validates the bishop movements
    ...
    if (((aux = 5) or (aux = 11)) and
      ...
      correctMovement := True;
    //validates the regular and double pawn movements
